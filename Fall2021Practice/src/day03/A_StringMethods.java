...
public class A_StringMethods {
	...
	public static void main(String[] args) {
         ...
         */ // contains den farkΔ± indexini verir, contains ise true false
        // 012345678
        String text = "Good";
        System.out.println("G harfinin indexi = " + text.indexOf("G")); // indexler 0 dan baΕ�lar
        System.out.println("d harfinin indexi = " + text.indexOf('d')); //3
        System.out.println("H harfinin indexi = " + text.indexOf("H")); // -1  : bulunamadΔ±, yok
        System.out.println("od nin indexi = " + text.indexOf("od")); // 2 : var ise ilk harfin indexini verir
        int index = text.indexOf("o"); // int deΔ�iΕ�kene atanabilir. kΓΌΓ§ΓΌk o harfi
        System.out.println("index = " + index); // 1 :  aynΔ± karakterden birden fazla var ise ilkini verir.
        ...
        /** lastIndexOf()
         *  String iΓ§inde aranan karakter(ler)in sondan itibaren ilk indexini varΔ±r
         *  indexOf un sondan olan hali fakat index numaralarΔ± deΔ�iΕ�mez.
         */
        ...
        System.out.println("ilk baΕ�tan i nun indexi = " + textt.indexOf("i")); //6
        System.out.println("----------");
        /**
         * charAt()
         * Δ°stenen noktadaki karakteri verir,
         * karakterlerin sΔ±rasΔ± 0 dan baΕ�lar, buna index denir.
        ...
        /** ReplaceFirst
        * Replace ile aynΔ± sadece ilk bulunanΔ± deΔ�iΕ�tirir
         */
        String txt = "Merhaba Dunya";

        System.out.println("orjinal hali = " + txt); //orjinal hali = Merhaba Dunya
        System.out.println("butun a larΔ±n nΔ±n degistigi hali = " + txt.replace("a", "e"));
        // butun a larΔ±n nΔ±n degistigi hali = Merhebe Dunye
        System.out.println("ilk bulunan a nΔ±n degistigi hali = " + txt.replaceFirst("a", "e"));
        // ilk bulunan a nΔ±n degistigi hali = Merheba Dunya
        System.out.println("----------");
        /** replaceAll()
         *
         */
         ...
         * bir stringin iΓ§erisinde karakter(ler)in var olup olmadΔ±Δ�Δ±nΔ± kontrol eder.
         * Sonuc boolean dir.
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. bΓΌyΓΌk kΓΌΓ§ΓΌk harf farkΔ± vardΔ±r. Sonuc boolean dir.
         *
         * equalsIgnorecase()
        ...
        System.out.println("EΕ�it mi = " + str.equalsIgnoreCase("mERHaba")); // true
        System.out.println("EΕ�it mi = " + str.equalsIgnoreCase("mERHa")); // false
    ...
    * bir stringe diΔ�erini ekler
     ...
     * */
        ...
        s = s.concat(s2);// yani degiskenin kendisine atama yapΔ±lΔ±rsa degeri kalici degisir.
        // s= s+s2; aynΔ± islemi yapar.
        System.out.println("s = " + s); // s = Hi everybody
        System.out.println("----------");
        /**
         * StringIsEmpty
         *  String tamamen boΕ� mu deΔ�il mi onu kontrol ediyor, sonuΓ§ true false
         */
        String str1 = "Hi";
        System.out.println("str1 iΓ§i boΕ� mu = " + str1.isEmpty()); //false

        String str2 = "";
        System.out.println("str2 iΓ§i boΕ� mu = " + str2.isEmpty()); //true

        String str3 = " ";
        System.out.println("str3 iΓ§i boΕ� mu = " + str3.isEmpty());  //false
        boolean bosMu = str3.isEmpty(); // boolean deΔ�iΕ�kenine atanabilir.
        ...
        System.out.println(str4.toUpperCase()); //TECHPROEDUCATΔ°ON
        ...
        System.out.println(str4);  //TECHPROEDUCATΔ°ON
         ...
         */
        String cumle = "Bu gΓΌn hava yagmurlu";
